...
interface ScheduleOption {
    ...
    exportIcs?: string;            // Optional ICS payload generated by exporter.js
}
...
| `courseflow_export` | JSON Object / metadata | Optional metadata for exported schedules; ICS files are generated client-side via `exporter.js`. |
